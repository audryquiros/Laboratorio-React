...
frostflow/ ├── public/ ├── src/ │ ├── assets/ │ ├── components/ │ │ ├── AutomationStatus/ │ │ ├── AyudaEstados/ │ │ ├── ConfirmacionModal/ │ │ ├── CursosForm/ │ │ ├── DateTimePicker/ │ │ ├── DeliveryCard/ │ │ ├── EntregasForm/ │ │ ├── Header/ │ │ ├── Layout/ │ │ ├── PlanEstudiosImporter/ │ │ ├── Sidebar/ │ │ ├── SummaryCard/ │ │ └── TemperatureIndicator/ │ ├── context/ │ ├── pages/ │ ├── routes/ │ ├── services/ │ ├── styles/ │ ├── utils/ │ ├── App.jsx │ └── main.jsx ├── db.json ├── package.json └── README.md
...
Disparador ↓ Consultar configuración ↓ ¿Automatización activa? ├── No → Fin │ └── Sí ↓ Consultar entregas ↓ Analizar riesgo ↓ ¿Necesita actualización? ├── No │ └── Sí → Actualizar entrega ↓ Registrar ejecución ↓ Fin
...
Autor
Audry Quiros, Proyecto académico desarrollado para el laboratorio de Front-End Development.
